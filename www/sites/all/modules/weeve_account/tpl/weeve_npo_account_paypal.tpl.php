...
<?php else: ?>
<div class="paypal-status paypal-verified"><span><?= t('Verified.') ?></span> <?= t('Your PayPal account is verified, you may now ') . l(t('propose a new project!'), 'account/' . $user->uid . '/projects');?></div>
<?php endif; ?>
